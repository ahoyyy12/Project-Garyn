...
namespace ProjectGaryn
{
    public class PlayerMovementState : IState
    {
        ...
        protected void RotateTowardsTargetRotation()
        {
            ...
            float smoothedAngle = Mathf.SmoothDampAngle(currentYAngle, stateMachine.ReusableData.CurrentTargetRotation.y, ref stateMachine.ReusableData.DampedTargetRotationCurrentVelocity.y, stateMachine.ReusableData.TimeToReachTargetRotation.y - stateMachine.ReusableData.DampedTargetRotationPassedTime.y);
